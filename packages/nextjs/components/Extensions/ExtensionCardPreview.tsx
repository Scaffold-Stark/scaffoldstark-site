...
export const ExtensionCardPreview = ({ title, description, command }: ExtensionCardPreviewProps) => {
  ...
  return (
    <div className="rounded-xl px-6 py-8 border border-[#3F00AC] bg-gradient-to-b from-[#322D59] via-[#1a1a1a] to-[#121212] relative overflow-hidden">
      {/* Content */}
      <div className="relative z-10">
        <h2 className="text-3xl font-bold text-left mb-6 tracking-wider text-[#B386FF]">{title}</h2>
