...
Otherwise, you can install Scarb `2.15.1` following the [instructions](https://docs.swmansion.com/scarb/download.html#install-via-asdf).
...
Otherwise, you can install Starknet Foundry `0.55.0` following the [instructions](https://foundry-rs.github.io/starknet-foundry/getting-started/installation.html#installation-via-asdf).
...
- Install starknet-devnet `0.7.2` via `asdf` ([instructions](https://github.com/gianalarcon/asdf-starknet-devnet/blob/main/README.md)).
...
- The configuration uses the `starknetfoundation/starknet-dev:2.15.1` image.
