...
If your Starknet Foundry version is not 0.45.0, you need to install it.
...
Otherwise, you can install Starknet Foundry `0.45.0` following the [installation instructions](https://foundry-rs.github.io/starknet-foundry/getting-started/installation.html#installation).
...
```bash
asdf set starknet-foundry 0.45.0
```
...
To ensure the proper functioning of scaffold-stark, your starknet-devnet version must be 0.4.2.
...
If your `starknet-devnet` version is not `0.4.2`, you need to install it.
...
This will allow you to download specific versions. You can install the compatible version **0.4.2** with:
...
```bash
asdf set starknet-devnet 0.4.2
```

Otherwise, you can simply run the following command in your terminal and follow the on-screen instructions.  
This will install the version **0.4.2** of Starknet Devnet:

```bash
curl -L https://raw.githubusercontent.com/Shard-Labs/starknet-devnet/main/install.sh | bash -s -- -v 0.4.2
```
