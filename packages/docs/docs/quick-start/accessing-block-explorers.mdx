...
:::info Scaffold-Stark v3 Default Explorer
Scaffold-Stark v3 uses **Voyager** as the default block explorer, configured via the `explorer` prop on `StarknetConfig`. Links go to `sepolia.voyager.online` for Sepolia and `voyager.online` for Mainnet.
:::
...
- Navigate your Scaffold Stark project and locate the "Block Explorer" button at the bottom left of the page.
  ...
  <img src="/docs/img/block-explorer-button.png" alt="block-explorer-button" style={{ width: "50%", height: "auto" }} />

- Click the "Block Explorer" button to open a list of available block explorers.

  <img src="/docs/img/block-explorer-popup.png" alt="block-explorer-popup" style={{ width: "50%", height: "auto" }} />
