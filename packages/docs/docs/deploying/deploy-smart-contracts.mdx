...
By default, Scaffold-Stark 2 provides predefined RPC endpoints for popular services such as [Alchemy](https://www.alchemy.com/starknet). This allows you to begin developing and testing your applications more easily, avoiding the need to register for this service.
