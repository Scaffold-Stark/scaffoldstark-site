...
- The extended object includes properties inherited from the `useSendTransaction` hook of starknet-start. You can check their [documentation](https://start.starknet-react.com/docs/hooks/useSendTransaction#sendasync) for the specific return values.
