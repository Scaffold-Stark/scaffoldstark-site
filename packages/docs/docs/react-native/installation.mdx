...
| `npm run chain` | Start local Starknet devnet |
| `npm run deploy` | Deploy contracts to active network |
| `npm run deploy:clear` | Deploy contracts with reset |
| `npm run compile` | Compile Cairo smart contracts |
