...
This will install:
- **Scarb 2.12.2** - Cairo package manager and build toolchain
- **Starknet Foundry 0.49.0** - Testing framework for Starknet
- **asdf** - Version manager for tool versions
- **Cairo 1.0 VSCode Extension** - Syntax highlighting and language support
- **Starknet Devnet 0.5.1** - Local development network
...
```bash
asdf install starknet-devnet 0.5.1
asdf set starknet-devnet 0.5.1
```
